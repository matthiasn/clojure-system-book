...
In the code above, we have used a couple of helpers from the ````birdwatch.ui.util```` **[namespace](https://github.com/matthiasn/BirdWatch/blob/730f445eaacf415d8ee8d22dc92e606b6d23efb6/Clojure-Websockets/MainApp/src/cljs/birdwatch/ui/util.cljs)**, all of which are pure functions:
